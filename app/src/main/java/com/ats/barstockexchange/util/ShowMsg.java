...
public class ShowMsg
{
    ...
    static ShowMessageCallback showMessageCallback;

    public static void setShowMessageCallbackListener(ShowMessageCallback showMessageCallback1)
    {
        showMessageCallback = showMessageCallback1;
    }

    public static void showException(Exception e, String method, Context context, boolean cancellable)
    {
        String msg = "";
        ...
        show(msg, context, cancellable);
    }

    public static void showResult(int code, String errMsg, Context context, boolean cancellable)
    {
        String msg = "";
        if (errMsg.isEmpty())
        {
    ...
    public static void showMsg(String msg, Context context, boolean cancellable)
    {
        show(msg, context, cancellable);
    }

    private static void show(final String msg, Context context, boolean cancellable)
    {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(context,R.style.AlertDialogTheme1);
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener()
        {
            public void onClick(DialogInterface dialog, int whichButton)
            {
                ...
                {
                    showMessageCallback.onOKClicked(msg);
                }
                return;
            }
        });
